  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        ...
        <p className="text-gray-500">Personaliza tu experiencia en la aplicación</p>
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">
                    {settings.integrations.api ? 'Conectado' : 'No conectado'}
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <h3 className="text-sm font-medium text-gray-900">Excel Integration</h3>
                  <p className="text-sm text-gray-500">
                    {settings.integrations.excel ? 'Conectado' : 'No conectado'}
                  </p>
                </div>
              </div>
              <button
