...
const mockActionPlans = [
  {
    ...
    completedActions: 8,
    causes: [
      { id: '1', description: 'Falta de capacitación', units: 45, comments: 'Personal nuevo' },
      { id: '2', description: 'Procedimientos desactualizados', units: 30, comments: 'No se han revisado en 6 meses' },
      { id: '3', description: 'Equipos defectuosos', units: 25, comments: 'Mantenimiento pendiente' }
    ],
    followupActions: [
      { id: '1', description: 'Actualizar procedimientos', status: 'completed', date: '2024-01-15', comments: 'Documentos actualizados y aprobados' },
      { id: '2', description: 'Capacitar al personal', status: 'in-progress', date: '2024-02-01', comments: 'En proceso de programación' },
      { id: '3', description: 'Revisar equipos', status: 'pending', date: '2024-02-10', comments: 'Pendiente de mantenimiento' }
    ]
  },
  {
    id: '2',
    ...
    completedActions: 4,
    causes: [
      { id: '1', description: 'Error en proceso', units: 40, comments: 'Proceso manual' },
      { id: '2', description: 'Falta de inspección', units: 35, comments: 'Personal insuficiente' },
      { id: '3', description: 'Material defectuoso', units: 25, comments: 'Proveedor nuevo' }
    ],
    followupActions: [
      { id: '1', description: 'Automatizar proceso', status: 'in-progress', date: '2024-02-05', comments: 'En desarrollo' },
      { id: '2', description: 'Contratar inspector', status: 'completed', date: '2024-01-25', comments: 'Proceso completado' },
      { id: '3', description: 'Auditar proveedor', status: 'pending', date: '2024-02-20', comments: 'Programado' }
    ]
  },
  {
    id: '3',
    ...
    completedActions: 2,
    causes: [
      { id: '1', description: 'Máquina obsoleta', units: 50, comments: 'Requiere actualización' },
      { id: '2', description: 'Tiempo muerto', units: 30, comments: 'Cambios frecuentes' },
      { id: '3', description: 'Desperdicios', units: 20, comments: 'Material no conforme' }
    ],
    followupActions: [
      { id: '1', description: 'Actualizar máquina', status: 'in-progress', date: '2024-02-01', comments: 'En proceso' },
      { id: '2', description: 'Optimizar cambios', status: 'completed', date: '2024-01-20', comments: 'Implementado' },
      { id: '3', description: 'Reducir desperdicios', status: 'pending', date: '2024-02-15', comments: 'Por iniciar' }
    ]
  }
];
...
export const ActionPlansHistory: React.FC = () => {
